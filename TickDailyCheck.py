...
def runcheck():
    ...
    timedict = {"night": [night_start, night_end, night_count], "morning": [morning_start, morning_end, morning_count], "afternoon": [afternoon_start, afternoon_end, afternoon_count]}
